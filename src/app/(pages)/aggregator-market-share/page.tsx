...
import { AggregatorMarketShare } from "@/features/aggregator-market-share/components/AggregatorMarketShare"

export default function AggregatorMarketSharePage() {
  return (
